...
function editarC1(columna){
	if(editando==0){
		...
		cambios.innerHTML = '<h6>Pulse Aceptar para guardar los cambios o cancelar para anularlos</h6>'+
...
'<form name = "formulario" action="Result.html" method="get" onsubmit="Aceptar()" onreset="Cancelar()">'+
...
function llenarTabla(x1, x2, x3, x4, x5, x6){
	...
	tabla.innerHTML = '<thead><tr><th colspan="2">'+x1+x6+'</th></tr></thead><tbody><tr><td>Calorias(kCal)</td><td>'+x2+'</td></tr><tr><td>grasas(g)</td><td>'+x3+'</td></tr><tr><td>Proteina(g)</td><td>'+x4+'</td></tr><tr><td>Carbohidratos(g)</td><td>'+x5+'</td></tr></tbody>';
}
